...
# --------------------------------------------------------------------------- #
# Friendly names of the 234 known Windows shell ids (DEFAULT_IDS display only —
# the id written to shell.nss stays English, e.g. id.add_to_favorites)
# --------------------------------------------------------------------------- #
PL_ID_DISPLAY = {
    "Account": "Konto",
    "Add A Network Location": "Dodaj lokalizację sieciową",
    "Add To Favorites": "Dodaj do ulubionych",
    "Add To Playlist": "Dodaj do listy odtwarzania",
    "Add To Windows Media Player List": "Dodaj do listy Windows Media Playera",
    "Adjust Date Time": "Ustaw datę i godzinę",
    "Administrator": "Administrator",
    "Align Icons To Grid": "Wyrównaj ikony do siatki",
    "All Control Panel Items": "Wszystkie elementy Panelu sterowania",
    "Application": "Aplikacja",
    "Arrange By": "Rozmieszcz według",
    "Autoplay": "Autoodtwarzanie",
    "Auto Arrange Icons": "Automatycznie rozmieść ikony",
    "Burn Disc Image": "Nagraj obraz dysku",
    "Cascade Windows": "Okna kaskadowo",
    "Cast To Device": "Przekaż do urządzenia",
    "Cleanup": "Czyszczenie",
    "Close All Windows": "Zamknij wszystkie okna",
    "Collapse": "Zwiń",
    ...
    "Copy": "Kopiuj",
    "Copy As Path": "Kopiuj jako ścieżkę",
    ...
    "Create Shortcuts": "Utwórz skróty",
    "Create Shortcuts Here": "Utwórz skróty tutaj",
    "Customize Notification Icons": "Dostosuj ikony powiadomień",
    "Customize This Folder": "Dostosuj ten folder",
    "Cut": "Wytnij",
    "Default": "Domyślne",
    "Desktop": "Pulpit",
    "Details": "Szczegóły",
    ...
    "Disconnect": "Rozłącz",
    "Disconnect Network Drive": "Rozłącz dysk sieciowy",
    ...
    "Erase This Disc": "Wymaż ten dysk",
    "Exit Explorer": "Zamknij Eksploratora",
    "Expand": "Rozwiń",
    "Expand All Groups": "Rozwiń wszystkie grupy",
    "Expand Group": "Rozwiń grupę",
    "Expand To Current Folder": "Rozwiń do bieżącego folderu",
    "Extract All": "Wyodrębnij wszystko",
    "Extract To": "Wyodrębnij do",
    "Extra Large Icons": "Bardzo duże ikony",
    "Favorites": "Ulubione",
    "File Access Denied": "Odmowa dostępu do pliku",
    "File Explorer": "Eksplorator plików",
    "File Explorer Options": "Opcje Eksploratora plików",
    "File In Use": "Plik w użyciu",
    "Folder": "Folder",
    "Folders": "Foldery",
    "Folder Access Denied": "Odmowa dostępu do folderu",
    "Folder In Use": "Folder w użyciu",
    "Folder Options": "Opcje folderów",
    "Format": "Formatuj",
    "General": "Ogólne",
    "Give Access To": "Udziel dostępu",
    "Go To": "Przejdź do",
    "Group By": "Grupuj według",
    "Hide": "Ukryj",
    "Import Pictures And Videos": "Importuj obrazy i wideo",
    "Include In Library": "Uwzględnij w bibliotece",
    "Insert Unicode Control Character": "Wstaw znak sterujący Unicode",
    "Install": "Zainstaluj",
    "Invert Selection": "Odwróć zaznaczenie",
    "Large Icons": "Duże ikony",
    "List": "Lista",
    "Lock All Taskbars": "Zablokuj wszystkie paski zadań",
    "Lock The Taskbar": "Zablokuj pasek zadań",
    "Make Available Offline": "Udostępnij offline",
    "Make Available Online": "Udostępnij online",
    "Manage": "Zarządzaj",
    "Map As Drive": "Mapuj jako dysk",
    "Map Network Drive": "Mapuj dysk sieciowy",
    "Maximize": "Maksymalizuj",
    "Media": "Multimedia",
    "Medium Icons": "Średnie ikony",
    "Merge": "Scal",
    ...
    "Network": "Sieć",
    "New": "Nowy",
    "News And Interests": "Wiadomości i zainteresowania",
    "New Folder": "Nowy folder",
    "New Item": "Nowy element",
    "Next Desktop Background": "Następne tło pulpitu",
    "Open": "Otwórz",
    "Open As Portable": "Otwórz jako przenośne",
    "Open Autoplay": "Otwórz Autoodtwarzanie",
    "Open Command Prompt": "Otwórz wiersz polecenia",
    "Open Command Window Here": "Otwórz okno poleceń tutaj",
    "Open File Location": "Otwórz lokalizację pliku",
    "Open Folder Location": "Otwórz lokalizację folderu",
    "Open In New Process": "Otwórz w nowym procesie",
    "Open In New Tab": "Otwórz w nowej karcie",
    "Open In New Window": "Otwórz w nowym oknie",
    "Open New Tab": "Otwórz nową kartę",
    "Open New Window": "Otwórz nowe okno",
    "Open Powershell Window Here": "Otwórz okno PowerShell tutaj",
    "Open Windows Powershell": "Otwórz Windows PowerShell",
    "Open With": "Otwórz za pomocą",
    "Options": "Opcje",
    "Paste": "Wklej",
    "Paste Shortcut": "Wklej skrót",
    "Permanently Delete": "Usuń trwale",
    "Personalize": "Personalizuj",
    "Personal Folder": "Folder osobisty",
    "Pictures": "Obrazy",
    "Pin Current Folder To Quick Access": "Przypnij bieżący folder do Szybkiego dostępu",
    "Pin To Quick Access": "Przypnij do Szybkiego dostępu",
    "Pin To Start": "Przypnij do Startu",
    "Pin To Start Menu": "Przypnij do menu Start",
    "Pin To Taskbar": "Przypnij do paska zadań",
    "Play": "Odtwórz",
    "Play With Windows Media Player": "Odtwórz w Windows Media Player",
    "Power": "Zasilanie",
    ...
    "Reconversion": "Ponowna konwersja",
    "Recycle Bin": "Kosz",
    "Redo": "Ponów",
    "Remove": "Usuń",
    ...
    "Remove Properties": "Usuń właściwości",
    "Rename": "Zmień nazwę",
    "Restart": "Uruchom ponownie",
    "Restore All Windows": "Przywróć wszystkie okna",
    "Restore Default Libraries": "Przywróć domyślne biblioteki",
    "Restore Previous Versions": "Przywróć poprzednie wersje",
    "Rotate Left": "Obróć w lewo",
    "Rotate Right": "Obróć w prawo",
    "Run": "Uruchom",
    "Run As Administrator": "Uruchom jako administrator",
    "Run As Another User": "Uruchom jako inny użytkownik",
    "Run As Different User": "Uruchom jako inny użytkownik",
    "Run With Powershell": "Uruchom w PowerShell",
    ...
    "Send To": "Wyślij do",
    "Set As Desktop Background": "Ustaw jako tło pulpitu",
    "Set As Desktop Wallpaper": "Ustaw jako tapetę pulpitu",
    "Share": "Udostępnij",
    "Share With": "Udostępnij przez",
    "Shield": "Tarcza",
    "Shortcut": "Skrót",
    "Show All Folders": "Pokaż wszystkie foldery",
    "Show Cortana Button": "Pokaż przycisk Cortany",
    "Show Desktop Icons": "Pokaż ikony pulpitu",
    "Show File Extensions": "Pokaż rozszerzenia plików",
    "Show Hidden Files": "Pokaż ukryte pliki",
    "Show Libraries": "Pokaż biblioteki",
    "Show Network": "Pokaż sieć",
    "Show Open Windows": "Pokaż otwarte okna",
    "Show Pen Button": "Pokaż przycisk pióra",
    "Show People On The Taskbar": "Pokaż Kontakty na pasku zadań",
    "Show Task View Button": "Pokaż przycisk widoku zadań",
    "Show The Desktop": "Pokaż pulpit",
    "Show This Pc": "Pokaż Ten komputer",
    "Show Touchpad Button": "Pokaż przycisk panelu dotykowego",
    "Show Touch Keyboard Button": "Pokaż przycisk klawiatury dotykowej",
    "Show Windows Side By Side": "Pokaż okna obok siebie",
    "Show Windows Stacked": "Pokaż okna jedno nad drugim",
    "Shut Down": "Zamknij system",
    "Sign Out": "Wyjdź",
    "Size": "Rozmiar",
    "Small Icons": "Małe ikony",
    "Sort By": "Sortuj według",
    "Start Menu": "Menu Start",
    "System": "System",
    "System Folder": "Folder systemowy",
    "Taskbar": "Pasek zadań",
    "Taskbar Settings": "Ustawienia paska zadań",
    "Task Manager": "Menedżer zadań",
    "Terminal": "Terminal",
    "This Pc": "Ten komputer",
    "Tiles": "Kafelki",
    "Troubleshoot Compatibility": "Rozwiąż problemy z zgodnością",
    "Turn Off Bitlocker": "Wyłącz funkcję BitLocker",
    "Turn On Bitlocker": "Włącz funkcję BitLocker",
    "Uninstall": "Odinstaluj",
    "Unpin From Quick Access": "Odepnij od Szybkiego dostępu",
    "Unpin From Start": "Odepnij od Startu",
    "Unpin From Start Menu": "Odepnij od menu Start",
    "Unpin From Taskbar": "Odepnij od paska zadań",
    "Videos": "Wideo",
    "View": "Widok",
