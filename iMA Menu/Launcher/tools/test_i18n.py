...
# --------------------------------------------------------------------------- #
section("widgets built in the source language follow a later switch")
i18n.set_language("en")
late_label = QLabel("Auto Update Plugins")
late_button = QPushButton("Check for Update")
check(late_label.text() == "Auto Update Plugins", "EN-built widget shows the source text")
i18n.set_language("pl")
check(late_label.text() == "Automatyczna aktualizacja wtyczek",
      f"EN-built label follows the switch ({late_label.text()!r})")
check(late_button.text() == "Sprawdź aktualizacje",
      f"EN-built button follows the switch ({late_button.text()!r})")
late_label.setText("Auto Check Updates")
check(late_label.text() == "Automatyczne sprawdzanie aktualizacji",
      "setText() while in EN is translated on the fly after the switch")
i18n.set_language("en")
check(late_label.text() == "Auto Check Updates", "and returns to the source text")
i18n.set_language("pl")
